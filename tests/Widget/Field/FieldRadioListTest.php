...
final class FieldRadioListTest extends TestCase
{
    ...
    public function testAutofocus(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            ...
            Field::widget()
                ->autofocus()
                ->radioList(new TypeForm(), 'int', ['items()' => [$this->sex]])
                ->render(),
        );
    }
    ...
    public function testItemsFromValues(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()
                ->radioList($formModel, 'string', ['itemsFromValues()' => [$this->sex]])
                ->render(),
        );
    }
    ...
    public function testValue(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()
                ->radioList(new TypeForm(), 'string', ['items()' => [$this->sex]])
                ->value('1')
                ->render(),
        );
    ...
    public function testValueWithForm(): void
    {
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()
                ->radioList($formModel, 'int', ['items()' => [$this->sex]])
                ->render(),
        );
        ...
        $this->assertEqualsWithoutLE(
            $expected,
            Field::widget()
                ->radioList($formModel, 'string', ['items()' => [$this->sex]])
                ->render(),
        );
