...
<input type="hidden" name="PersonalForm[attachFiles]" value=""><input type="file" id="personalform-attachfiles" class="has-success form-control" name="PersonalForm[attachFiles]">
...
<div class="form-group field-personalform-attachfiles">
<label class="control-label" for="personalform-attachfiles">Attach Files</label>
<input type="file" id="personalform-attachfiles" class="has-success form-control" name="PersonalForm[attachFiles]">
