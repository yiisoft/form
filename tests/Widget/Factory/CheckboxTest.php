...
final class CheckboxTest extends TestCase
{
    ...
    public function testValues(): void
    {
        ...
        $this->assertSame(
            $expected,
            Checkbox::widget(['for()' => [$this->formModel, 'bool'], 'value()' => [true]])->render(),
        );
        ...
        $this->assertSame(
            $expected,
            Checkbox::widget(['for()' => [$this->formModel, 'int'], 'value()' => [1]])->render(),
        );
        ...
        $this->assertSame(
            $expected,
            Checkbox::widget(['for()' => [$this->formModel, 'string'], 'value()' => ['1']])->render(),
        );
        ...
        $this->assertSame(
            $expected,
            Checkbox::widget(['for()' => [$this->formModel, 'toNull'], 'value()' => ['1']])->render(),
        );
    }
