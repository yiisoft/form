...
final class FieldRangeTest extends TestCase
{
    ...
    public function testValue(): void
    {
        ...
        <input type="range" id="typeform-tonull" name="TypeForm[toNull]" value="0" oninput="i1.value=this.value">
        <output id="i1" name="i1" for="TypeForm[toNull]">0</output>
        </div>
        HTML;
        ...
        <input type="range" id="typeform-string" name="TypeForm[string]" value="1" placeholder="Typed your text string." oninput="i1.value=this.value">
